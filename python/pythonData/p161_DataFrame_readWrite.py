...
mylist = list(10 * onedata for onedata in range(1,26))       # list comprehension - 리스트 안에 리스트가 포함되어 있음.
print(mylist)
...
print('\n이순신, 김유신 include row data read of series')
...
print('\n 이순신, 광주, 목포 실적 include row data read of DataFrame')       # series, dataframe 차이 : 한개냐 , 여러개냐 차이.
result = myframe.loc[['이순신','강감찬'],['광주', '목포']]
print(type(result))
print(result)
print('-' * 50)

print('\n 이순신 ~ 강감찬 / 서울 ~ 목표 실적 include row data read of DataFrame')
